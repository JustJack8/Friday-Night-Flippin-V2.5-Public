...
class PauseSubState extends MusicBeatSubstate
{
	...
	public static var closed:Bool = false;
	...
	public function resume():Void //I thought it would be cool -- Just Jack
	{
		...
		FlxTween.tween(levelInfo, {alpha: 0, y: 15}, 1.5, {ease: FlxEase.quartInOut});
		FlxTween.tween(levelDifficulty, {alpha: 0, y: 15}, 1.5, {ease: FlxEase.quartInOut});
		FlxTween.tween(blueballedTxt, {alpha: 0, y: 15}, 1.5, {ease: FlxEase.quartInOut});
		FlxTween.tween(practiceText, {alpha: 0, y: 15}, 1.5, {ease: FlxEase.quartInOut});
		FlxTween.tween(chartingText, {alpha: 0}, 1.5, {ease: FlxEase.quartInOut});
