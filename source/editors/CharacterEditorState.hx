...
class CharacterEditorState extends MusicBeatState
{
	...
	override function create()
	{
		...
		loadChar(!daAnim.startsWith('sen'), false);
	...
	var TemplateCharacter:String = '{
		"animations": [
			...
			"image": "characters/pump_swag_assets",
			"position": [
				-50,
				-90
			],
	...
	function addSettingsUI() {
		...
		check_player.checked = daAnim.startsWith('sen');
	...
	function addCharacterUI() {
		...
		imageInputText = new FlxUIInputText(15, 30, 200, 'characters/sen', 8);
	...
	function reloadCharacterImage() {
		...
		if(char.animationsArray != null && char.animationsArray.length > 0) {
			...
			char.quickAnimAdd('idle', 'BF idle dance0');
		}
